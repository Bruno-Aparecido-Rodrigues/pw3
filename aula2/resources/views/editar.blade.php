     ...
     @csrf    
            <div class="row">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" value="{{$cliente->nome}}" name="nome">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlInput1" class="form-label">Telefone:</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1" value="{{$cliente->telefone}}" name="telefone">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="exampleFormControlInput1" value="{{$cliente->data_de_contato}}" name="data_de_contato">
                </div>
                <div class="mb-3">
